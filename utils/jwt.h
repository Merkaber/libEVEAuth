    ...
    public:
                ...
                : token(token)
        {
            ...
            auto fix_padding = [](std::string& str) {
                switch (str.size() % 4) {
                    case 1:
                        str += EVEAuth::Base64::base64_url_safe_fill;
            ...
            header = EVEAuth::Base64(header).decode_url_safe();
            payload = EVEAuth::Base64(payload).decode_url_safe();
            signature = EVEAuth::Base64(signature).decode_url_safe();
    ...
    public:
        ...
        std::string sign(const T& algo) const {
            ...
            auto encode = [](const std::string& data) {
                auto base = EVEAuth::Base64(data).encode_url_safe();
                auto pos = base.find(EVEAuth::Base64::base64_url_safe_fill);
